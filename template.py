...
for filepath in list_of_files:
    ...
    """
    How exists_ok works: if "directory" already exists os.makedirs() 
    will not raise an error, and it will do nothing.
    If "my directory doesn't exist, it will create the directory.
    """
    if filedir != "":
